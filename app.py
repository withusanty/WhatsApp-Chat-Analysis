...
st.markdown(
    'Note: Your data is 100% safe and secure, we are not taking any backup, even we don\'t have any access to this webapp after deployment. So, feel free to use. For any query/feedback/suggestions feel free to connect with me on given above linkdin id.')
